# MASA PharmaCore Inventory

Pharmaceutical stock management system tracking medication inventories and expiry dates
...
```bash
python "Pharmacy Inventory System in Python/index.py"
```
...
```
.
├── Pharmacy Inventory System in Python
├── screenshots/
│   └── app_interface.png
├── .gitignore
├── LICENSE             # MIT License
